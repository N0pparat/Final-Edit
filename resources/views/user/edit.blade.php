        ...
        <form action="/forum/update/{{$pertanyaan->id}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                 <div class="form-group">
                     <label for="judul">ชื่อเรื่อง</label>
                    <input type="text" class="form-control  @error('judul') is-invalid @enderror" name="judul" placeholder="ชื่อเรื่อง" id="judul" value="{{$pertanyaan->judul}}">
                </div>
                <div class="form-group">
                        <label for="exampleInputPassword1">ตอบกลับ</label>
                ...
                <div class="form-group">
                    ...
                    <a href="/forum/show/{{$pertanyaan->id}}" type="submit" class="btn btn-light mt-3">back</a>
