...
<div class="card-header">
    <div class="a">
        <p style="text-align: center; font-size:30px; margin-top:50px">พูดคุยเรื่อง One Piece <br><br>
        </div>
       <div class="b"></div> <a href="/forum/create" type="submit" class="btn btn-primary text-white btn-md text-dark" style="border-radius:50px; margin-bottom:25px" >เริ่มบทสนทนา</a>
    </p>
</div>
                ...
                <div class="card mb-10">
                    <div class="card-body">
                        <div class="media forum-item">
                            <a href="" data-toggle="collapse" data-target=".forum-content"><img src="{{$tanya->user->profile->getAvatar()}}" class="mr-3 rounded-circle" width="100" alt="User" /></a>
